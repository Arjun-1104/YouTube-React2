...
var nameList = [
  ...
  export function formatviews(view) {
    if (view < 1000) {
      return view;
 ...
 // moment.js, day.js
  export function timeAgo(time) {
    ...
    const now = new Date();
    const diff = Math.floor((now - uploadTime) / 1000);
