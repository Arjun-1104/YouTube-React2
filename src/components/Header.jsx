...
const Header = () => {
  ...
  const handleShowData = (text) => {
    dispatch(setCategory(text));
    setShowSearchData(text);
    setInputText(text);
  };

  return (
    <div className="flex justify-between px-5 fixed w-[100vw] bg-white py-2 z-10">
      <div className="flex w-[10%] justify-between items-center">
        ...
        <img
          ...
          alt=""
          // onClick={() => navigate("/")} // redirect home page on click
        />
        </Link>
      </div>
      ...
      <div className="flex w-[40%] justify-between">
        <div className="flex w-[90%] items-center rounded-full">
          ...
          >
            <CiSearch size={"24px"} onClick={() => handleShowData(inputText)}/>
          </div>
        </div>
        <div
      ...
      <div className=" flex items-center w-[15%] justify-around">
        <div className="flex items-center bg-gray-100 rounded-full py-1.5 px-3 gap-2 cursor-pointer hover:bg-gray-200">
