...
const Watch = () => {
  ...
  function formatviews(view) {
    if (view < 1000) {
      ...
      return Math.floor(view / 100) / 10 + "K";
    } else if (view < 1000000000) {
      return Math.floor(view / 100000) / 10 + "M";
    } else {
      return Math.floor(view / 100000000) / 10 + "B";
    }
  }
  ...
  return (
    <div className={`${open ? "ml-56" : "ml-20"} px-8 flex`}>
        ...
        <div className="">
          ...
          <div className=" flex items-center w-[100%] justify-between">
            <div className=" flex items-center w-[40%]">
              ...
              <button
                type="button"
                className="cursor-pointer font-semibold rounded-full px-4 py-1.5 bg-black text-white"
              >
                Subscribe
              </button>
            </div>
            ...
            <div className="flex w-[53%]  justify-between items-center">
              <div className=" flex items-center rounded-full bg-gray-100">
                <div className="flex items-center gap-1 ps-4 pe-2 py-1.5 rounded-l-full hover:bg-gray-200 cursor-pointer">
                  <AiOutlineLike size={"20px"} />
                  <h2 className="font-medium">{formatviews(item?.statistics?.likeCount) && 0}</h2>
                </div>
                <div className=" ps-2 pe-4 py-2 rounded-r-full hover:bg-gray-200 border-l cursor-pointer">
                  <AiOutlineDislike size={"20px"} />
                </div>
              </div>
              <button
                type="button"
                className="flex items-center font-semibold rounded-4xl px-4 py-1.5 bg-gray-100 gap-2 hover:bg-gray-200 cursor-pointer"
              >
              ...
              <button
                type="button"
                className="flex items-center rounded-full p-2 bg-gray-100 hover:bg-gray-200 cursor-pointer"
              >
